...
module.exports = function(params, opts, callback) {
	...
	url = 'https://en.wikipedia.org/w/api.php?action=parse&page=Clifford_Brown&prop=categories%7Cexternallinks%7Clinks%7Ctext&lang=en&redirects=true&format=json';
	console.log(url);
